...
<nav id="navbarContent" class="page__navbar">
    <div class="page__navbar__logo">
        <a class="page__navbar__logo" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(asset('assets/images/logo3212.png')); ?>" alt="" style="max-width:100%">
        </a>
...
<?php /**PATH /Users/arthur/Documents/cassino_crackeado/resources/views/includes/navbar_left.blade.php ENDPATH**/ ?>